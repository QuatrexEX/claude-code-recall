...
```
+----------------------------------+----------------------------------------+
| 検索: [          ]               | プロジェクト: C:\Users\...\MyProject   |
| [x] システムセッション除外        | セッションID: abc123-def456           |
| [x] スラッシュコマンド除外        |                                        |
|                                  | 👤 User  [2026-01-24 10:30:00]        |
| セッション数: 42 / 100           | こんにちは、Claude!                    |
|                                  | ────────────────────────────────────── |
| プロジェクト | 日時    | メッセージ| 🤖 Assistant  [2026-01-24 10:30:05]   |
| CC\MyProj   | 01-24   | こんに... | こんにちは！何かお手伝いできることは  |
| CC\OtherPrj | 01-23   | 教えて... | ありますか？                           |
+----------------------------------+----------------------------------------+
```
